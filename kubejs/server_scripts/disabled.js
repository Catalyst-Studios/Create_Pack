...
ServerEvents.recipes(catalyst => {
    ...
    catalyst.remove({output: "ironfurnaces:augment_blasting"})
    catalyst.remove({output: "ironfurnaces:augment_smoking"})
    catalyst.remove({output: "ironfurnaces:augment_factory"})
    catalyst.remove({output: "ironfurnaces:augment_generator"})
    catalyst.remove({output: "ironfurnaces:augment_speed"})
    catalyst.remove({output: "ironfurnaces:augment_fuel"})
    catalyst.remove({output: "appflux:fe_cell_housing"})
    catalyst.remove({id: "appflux:1k_fe_cell"})
    catalyst.remove({id: "appflux:4k_fe_cell"})
    catalyst.remove({id: "appflux:16k_fe_cell"})
    catalyst.remove({id: "appflux:64k_fe_cell"})
    catalyst.remove({id: "appflux:256k_fe_cell"})
    catalyst.remove({id: "appflux:1m_fe_cell"})
    catalyst.remove({id: "appflux:4m_fe_cell"})
    catalyst.remove({id: "appflux:16m_fe_cell"})
    catalyst.remove({id: "appflux:64m_fe_cell"})
    catalyst.remove({id: "appflux:256m_fe_cell"})
    catalyst.remove({output: "appflux:printed_energy_processor"})
    catalyst.remove({output: "appflux:energy_processor"})
    catalyst.remove({output: "jamd:portal_block"})
    catalyst.remove({output: "ae2:calculation_processor_press"})
    catalyst.remove({output: "ae2:engineering_processor_press"})
    catalyst.remove({output: "ae2:logic_processor_press"})
    catalyst.remove({output: "ae2:silicon_press"})
    catalyst.remove({output: "ae2:calculation_processor_press"})
